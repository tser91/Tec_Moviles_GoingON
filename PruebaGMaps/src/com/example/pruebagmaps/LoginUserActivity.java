...
public class LoginUserActivity extends FragmentActivity  {
	...
	private JSONArray fbEventsInfo= null;
	...
	public void setFbEventsInfo(JSONArray fbEvInfo) {
		fbEventsInfo = fbEvInfo;
		System.out.println("arrary inicial de evs de fb es "+fbEventsInfo);
	}
...
/*
	...
	public void finishedAuth() {
		...
		if (fbEventsInfo!=null){
			intent.putExtra("fbEventsInfo", fbEventsInfo.toString());
		}
		else{
	...
	public void onAccessGrant(String accessToken) {
		...
		async.getUserInfo(new UserInfoRequestListener() {
			...
			public void onError(String errorMsg) {
				...
				Toast.makeText(LoginUserActivity.this, errorMsg, Toast.LENGTH_LONG)
				.show();
			}
			...
			public void onUserInfoFetched(User user) {
				...
				Toast.makeText(LoginUserActivity.this, user.getFirstName() + " " + user.getLastName(), Toast.LENGTH_LONG)
				.show();                
			}
		});

		
		async.getVenueDetail("40a55d80f964a52020f31ee3", new FoursquareVenueDetailsResquestListener() {
			...
			public void onVenueDetailFetched(Venue venues) {
				venues.getLocation().getLat();
				venues.getLocation().getLng();
				venues.getName();
				Toast.makeText(LoginUserActivity.this, venues.getName()+", Lat:"+venues.getLocation().getLat()
						+", Long:"+venues.getLocation().getLng(), Toast.LENGTH_LONG)
						.show();
			}
		});
