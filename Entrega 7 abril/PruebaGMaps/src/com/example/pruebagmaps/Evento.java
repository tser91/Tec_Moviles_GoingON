...
public class Evento{
	...
	public Evento(Drawable eventPhoto, String nombreEvento, String descripcionEvento) {
        super();
    ...
    public Evento(Drawable eventPhoto, String nombreEvento, String descripcionEvento, long id,double Lat, double Long) {
        super();
        this.event_Image = eventPhoto;
        this.event_Name = nombreEvento;
        this.event_description = descripcionEvento;
